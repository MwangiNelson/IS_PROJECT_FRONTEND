...
import { AppButton, IconButton, MagicButton } from "../../recyclables/buttons";
import AiTab from "./_sideNavComponents/AiTab";
import ProsTab from "./_sideNavComponents/ProsTab";
import ChatPanel from "./_panels/ChatTab";

function Chat() {
  const [currentTab, setCurrentTab] = useState(0);

  const TabView: React.FC[] = [AiTab, ProsTab, AiTab];
